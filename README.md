...
![coverage](https://progress-bar.dev/87?title=progress)  ![functions](https://progress-bar.dev/215?title=functions)
...
A great thanks to Andreas Hadjiprocopis [Perlmonks](https://www.perlmonks.org/?node_id=1165397), [email](emailto:bliako@cpan.org), [git](https://github.com/hadjiprocopis).

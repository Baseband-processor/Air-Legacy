...
perlT:
	...
	(cd ./$(PERL_AIR_LORCON_DIR) && sudo perl Makefile.PL OPTIMIZE="-oS  -ffunction-sections -fdata-sections -faggressive-loop-optimizations -ffinite-math-only -fdce -fdelete-null-pointer-checks -ffast-math -fdevirtualize-speculatively -free -floop-nest-optimize -fno-asynchronous-unwind-tables  -Qn" && sudo make && sudo make test && sudo make install )
